...
export const themes: Theme[] = [
  ...
  },
  {
    id: 'cyber',
    name: 'Cyber-Organic',
    description: 'Inspirado en Nothing OS - negro y lima',
    preview: { primary: '#99be64', secondary: '#171d10', accent: '#090c04' },
    light: {
      '--background':            'oklch(0.98 0.01 135)',
      '--foreground':            'oklch(0.10 0.02 135)',
      '--card':                  'oklch(1 0 0)',
      '--card-foreground':       'oklch(0.10 0.02 135)',
      '--popover':               'oklch(1 0 0)',
      '--popover-foreground':    'oklch(0.10 0.02 135)',
      '--primary':               'oklch(0.65 0.18 135)',
      '--primary-foreground':    'oklch(0.10 0.02 135)',
      '--secondary':             'oklch(0.92 0.05 135)',
      '--secondary-foreground':  'oklch(0.18 0.04 135)',
      '--muted':                 'oklch(0.95 0.02 135)',
      '--muted-foreground':      'oklch(0.45 0.04 135)',
      '--accent':                'oklch(0.72 0.16 135)',
      '--accent-foreground':     'oklch(0.10 0.02 135)',
      '--destructive':           'oklch(0.55 0.22 25)',
      '--destructive-foreground':'oklch(0.98 0.01 25)',
      '--border':                'oklch(0.88 0.04 135)',
      '--input':                 'oklch(0.93 0.03 135)',
      '--ring':                  'oklch(0.65 0.18 135)',
      '--radius':                '1.5rem',
    },
    dark: {
      '--background':            'oklch(0.06 0.01 135)',
      '--foreground':            'oklch(0.95 0.02 135)',
      '--card':                  'oklch(0.10 0.015 135)',
      '--card-foreground':       'oklch(0.95 0.02 135)',
      '--popover':               'oklch(0.10 0.015 135)',
      '--popover-foreground':    'oklch(0.95 0.02 135)',
      '--primary':               'oklch(0.72 0.18 135)',
      '--primary-foreground':    'oklch(0.06 0.01 135)',
      '--secondary':             'oklch(0.15 0.03 135)',
      '--secondary-foreground':  'oklch(0.92 0.02 135)',
      '--muted':                 'oklch(0.12 0.02 135)',
      '--muted-foreground':      'oklch(0.60 0.04 135)',
      '--accent':                'oklch(0.58 0.14 135)',
      '--accent-foreground':     'oklch(0.95 0.02 135)',
      '--destructive':           'oklch(0.65 0.22 25)',
      '--destructive-foreground':'oklch(0.98 0.01 25)',
      '--border':                'oklch(0.18 0.02 135)',
      '--input':                 'oklch(0.12 0.015 135)',
      '--ring':                  'oklch(0.72 0.18 135)',
      '--radius':                '1.5rem',
    },
  },
  {
